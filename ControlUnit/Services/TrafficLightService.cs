...
public class TrafficLightService : ITrafficLightService
{
    ...
    public (TrafficLightStatus, TrafficLightStatus) GetSetStatuses(TrafficLightSet trafficLightSet1, TrafficLightSet trafficLightSet2)
    {
        ...
        if (trafficLightSet1.Status == TrafficLightStatus.Transition && trafficLightSet2.Status == TrafficLightStatus.Stop)
        {
        ...
        if (trafficLightSet2.Status == TrafficLightStatus.Transition && trafficLightSet1.Status == TrafficLightStatus.Stop)
        {
